 ...
 * test example gdm
 *
 *  Copyright (C) 2008, Simon H. Rasmussen, The Bioinformatics Centre, University of Copenhagen.
 *
...
int main(void) {
	...
	for(uint i = 0;i < s*O_SIZE-1;i=i+s){
	  parvec.push_back(4);
	}
	for(double i = O_SIZE-1;i >= 1;i=i-1){
	  parvec.push_back(8);
	}
...
/*
	...
	((GDMNode*)to0)->get_densities()->set_SumOfCounts(1000);
