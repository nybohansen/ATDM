...
int main(void) {
	...
	CPD to0_cpd;
	to0_cpd.set_shape(H_SIZE,O_SIZE); 
    to0_cpd.set(0,0,0.2);    
    to0_cpd.set(0,1,0.7);    
    to0_cpd.set(1,0,0.4);    
    to0_cpd.set(1,1,0.6);
	...
	Node* to0 = NodeFactory::new_mixed_node(O_SIZE, "to0", false, to0_cpd);
	...
	Node* mo0 = NodeFactory::new_mixed_node(O_SIZE, "mo0",true);
