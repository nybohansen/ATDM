 ...
 * hmm_multinomial.cpp
 *
 *  Copyright (C) 2008, Thomas Hamelryck, The Bioinformatics Centre, University of Copenhagen.
 *
...
int main(void) {
	...
	Node* to0 = NodeFactory::new_multinomial_node(O_SIZE, "to0", true);
	((MultinomialNode*)to0)->get_densities()->set_parameters(to0_cpd);
	...
	Node* mo0 = NodeFactory::new_multinomial_node(O_SIZE, "mo0", init_random);
