 ...
 * hmm_torus.h
 *
 *  Copyright (C) 2008, Thomas Hamelryck, Martin Paluszewski, Wouter Boomsma, The Bioinformatics Centre, University of Copenhagen.
 *
...
int main(void) {
	...
	Node* to0 = NodeFactory::new_vonmises2d_node("to0", mus, kappas);
	...
	Node* mo0 = NodeFactory::new_vonmises2d_node("mo0");
